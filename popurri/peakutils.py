...
def fit_gaussian_spec(w, f, imin, imax1, imax2, amp_hint=-0.5, cen_hint=None, wid_hint=0.01, shift_hint=0.8, minmax='min', nfitmin=None, returntype='pandas',
                    #    barmsg=''
                       ):
    ...
    for i in tqdm(range(npeak)):  # for each peak
