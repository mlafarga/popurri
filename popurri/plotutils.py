...
def mpl_custom_basic():
    ...
    mpl.rcParams.update({
        ...
        # 'axes.prop_cycle': mpl.cycler(color=colorcycles['vega_category10']),
        # Axes offset disable
...
def figout(fig, sv=True, filout='test', svext=['pdf'], sh=False, cl=True):
    """
...
def multiline(xs, ys, c, ax=None, **kwargs):
    ...
    See also https://stackoverflow.com/questions/8342549/add-colorbar-to-a-sequence-of-line-plots
